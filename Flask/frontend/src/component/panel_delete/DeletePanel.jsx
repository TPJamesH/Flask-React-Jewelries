...
import useRefDeleteJewelry from './hook/useRefDeleteJewelry'

export default function DeletePanel({ item, reloadFunction, setItems }) {
    let [isOpen, setIsOpen] = useState(false)
    const { DeleteJewelry } = useRefDeleteJewelry();
    function open() {
        setIsOpen(true)
    }
                        ...
                        >
                                    ...
                                    <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                                        ...
                                        <div className="mt-2">
                                            <p className="text-sm text-gray-500">
                                                Are you sure you want to delete this jewelry ? All of the data will be permanently removed.
                            ...
                            <div className="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                                <button
                                    type="button"
                                    onClick={() => {
                                        DeleteJewelry(item.token, reloadFunction, setItems)
                                        close();
                                    }}
